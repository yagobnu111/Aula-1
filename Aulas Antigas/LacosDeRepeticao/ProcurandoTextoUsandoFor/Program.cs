...
namespace ProcurandoTextoUsandoFor
{
    class Program
    {
        ...
        static void VersãoPrópria()
        {
           ...
           var countFind = 0;
            ...
            Console.WriteLine("Escreva uma palavra de 4 caracteres para achar : ");
            ...
            Console.WriteLine($"Foram achadas {countFind} palavras no texto ");
        }

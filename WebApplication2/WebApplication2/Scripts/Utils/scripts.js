...
$(document).ready(function () {
    //adicionando uma fuñção ao click do botão
    $('#Button1').click(function () {
        ...
        //$.getJSON("https://viacep.com.br/ws/RS/Porto%20Alegre/all/json/", function (data) {
            $.each(data, function (key, value) {
                ...
                $('#divContent').append('<table id="example" class="table table - striped table - bordered" style="width: 100 %"> <thead> <th> <th class="text-justify">' + value.logradouro + '</th></th></thead></table>');
                $('#divContent').append('<tbody> <tr> <td> CEP:' + value.cep + '</td> </tr> </tbody>');
                $('#divContent').append('<tbody> <tr> <td> UF:' + value.uf + '</td> </tr> </tbody>');
                $('#divContent').append('<tbody> <tr> <td> Localidade::' + value.localidade + '</td> </tr> </tbody>');
                $('#divContent').append('<tbody> <tr> <td> Bairro:' + value.bairro + '</td> </tr> </tbody>');
                $('#divContent').append('<tbody> <tr> <td> Complemento:' + value.complemento + '</td> </tr> </tbody>');
                $('#divContent').append('<tbody> <tr> <td> Unidade:' + value.unidade + '</td> </tr> </tbody>');
                $('#divContent').append('<tbody> <tr> <td> Gia:' + value.gia + '</td> </tr> </tbody>');
            });
        });
    });